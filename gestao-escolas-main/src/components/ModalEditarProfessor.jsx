...
function ModalEditarProfessor({ professorAtual, onClose, onUpdate }) {
  const [nome, setNome] = useState(professorAtual.nome);
  const [dataNascimento, setDataNascimento] = useState(professorAtual.dataNascimento || "");
  const [especialidade, setEspecialidade] = useState(professorAtual.especialidade || "");
  const [status, setStatus] = useState(professorAtual.status);
